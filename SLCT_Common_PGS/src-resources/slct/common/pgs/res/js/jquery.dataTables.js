...
(/** @lends <global> */function( $ ) {
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		else
		{
			...
			for ( i=0 ; i<visibleColumns.length ; i++ ) {
				...
				//CMC- Falla porque intenta acceder a headerCells[5] y solo llega hasta el 4
		...
		if ( (tableWidthAttr || scrollX) && ! oSettings._reszEvt ) {
			$(window).bind('resize.DT-'+oSettings.sInstance, _fnThrottle( function () {
				...
				//CMC -> SIGA problema con el body(show)
	...
	//CMC funcion para calcular los pixeles de ancho de la barra de scrollY
	...
	function _fnCallbackFire( settings, callbackArr, e, args )
	{
		...
		if ( callbackArr ) {
			ret = $.map( settings[callbackArr].slice().reverse(), function (val, i) {
				//CMC -> problema del alineamiento del scrollX scrollY en las tablas
				if(callbackArr == "aoDrawCallback"){
					$(".dataTables_scrollHeadInner").css("padding-right",getScrollBarWidth()+"px");
				}
				//CMC
